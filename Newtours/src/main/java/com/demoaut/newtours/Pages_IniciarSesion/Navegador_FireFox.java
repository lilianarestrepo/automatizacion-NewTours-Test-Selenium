 ...
 *
 */
public class Navegador_FireFox {
	static File directory = new File ("C:\\Users\\SBMEDADMIN\\Documents\\NewTours-Test-Automatization\\pantallafirefox");/* variable que contiene la ruta 
 ...
 * que nos permite usar sql
	 */
	public static void navegando_FireFox(String UserName, String PassWord, int i) throws FilloException {
		int sin = i*20;
		///paso 1
