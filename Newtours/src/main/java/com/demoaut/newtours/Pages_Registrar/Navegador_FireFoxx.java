...
/**Clase la cual permite navegar en FireFox, en este probaremos los datos
 ...
 *
 */
public class Navegador_FireFoxx {
	static File directory = new File ("C:\\Users\\SBMEDADMIN\\Documents\\NewTours-Test-Automatization\\pantallaFireFox_Registro");/* variable que contiene la ruta 
	 ...
	 */
	public static void navegando_FireFoxx(String nombre, String apellido, String telefono, String correo, String direccion,
		...
		casemiro.findElement(By.xpath("//*[@class='mouseOut' and @width='77']")).click();
